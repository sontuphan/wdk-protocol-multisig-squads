 ...
 * @property {MultisigCoordinatorFactory} [coordinator] - Builds the coordinator the account votes through, from a `CoordinatorSigner` over the member's key rather than the account holding it. Omit it and there is no coordinator: the account casts each vote in its own transaction.
...
export type SolanaMultisigSquadsSigningConfig = {
    /**
     * - Builds the coordinator the account votes through, from a `CoordinatorSigner` over the member's key rather than the account holding it. Omit it and there is no coordinator: the account casts each vote in its own transaction.
     */
